...
from DjangoUnlimited.settings import DEFAULT_FROM_EMAIL, BASE_DIR, BACKUP_ROOT, JOB_ID
...
def generate_statistics(request):
    ...
    if request.method == "POST":
        ...
        internships_posted = get_total_jobs(Job.objects.filter(job_type_id_id=JOB_ID, is_active='Accepted'))

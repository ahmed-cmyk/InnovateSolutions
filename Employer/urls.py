...
urlpatterns = [
    ...
    path('edit_employer_profile/<int:id>', views.edit_profile, name='admin_edit_employer_profile'),
    path('view_employer_profile', views.view_profile, name='view_employer_profile'),
    path('view_employer_profile/<int:id>', views.view_profile, name='admin_view_employer_profile'),
